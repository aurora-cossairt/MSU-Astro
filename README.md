...
There is more than one way to mathematically represent kinetic energy density (the variable represented on the Kolmogorov Power Spectra). While these definitions are mathematically equivalent, each comes with its own set of implicit assumptions. These assumptions affect how well the mathematical formalism represents physical reality.
